...
## Executing Zowe Docker Container 
 ...
 - adjust `docker start` command
   ...
   - `EXTERNAL_CERTIFICATE=<keystore.p12>` - location of p12 keystore.
   - `EXTERNAL_CERTIFICATE_ALIAS=<alias>` - valid alias within keystore
   - `EXTERNAL_CERTIFICATE_AUTHORITIES=<CA.cer>` - location of x509 Certificate Authority
